...
+
image::images/new/matrix-room-accept-invite.jpg[align="left", width=60%]
+
--
. Click on your room.
...
. You will be prompted to enter your credentials, as shown below:
+
image::images/rchat-login-credentials.png[align="left", width=40%]
+
{blank}
+
====
...
+
image::images/rchat-room.png[align="left", width=40%]
