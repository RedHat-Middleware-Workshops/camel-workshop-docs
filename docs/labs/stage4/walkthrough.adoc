...
//:url-docserver: https://docserver-webapp.apps.cluster-bhnnw.dynamic.redhatworkshops.io/
...
:ico-discord: pass:a[<svg width="1024px" height="1024px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"> \
      <circle cx="512" cy="512" r="512" style="fill:#ED4345"/> \
      <g transform="scale(1.2, 1.2) translate(-90,-90)"> \
         {ico-d-path} \
      </g> \
    </svg>]
...
{blank}
+
image::images/new/dev-close-tabs.png[align="left", width=100%]
+
{empty} +
...
[subs=attributes]
++++
<div style="font-family: 'Roboto', 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #1A1A1E; color: #dbdee1; padding: 16px; display: flex; align-items: flex-start; gap: 16px; width: 30%; max-width: 600px; box-sizing: border-box;">
  <div style="flex-shrink: 0; width: 50px; height: 50px; border-radius: 50%; background-color: #DA373C; display: flex; align-items: center; justify-content: center; overflow: hidden; margin-top: 2px;">
    {ico-discord}
  </div>
  <div style="display: flex; flex-direction: column; width: 100%;">
    <div style="display: flex; align-items: center; margin-bottom: 2px; flex-wrap: wrap;">
      <span style="color: #f2f3f5; font-weight: 400; font-size: 18px; margin-right: 6px; cursor: pointer;">camelbot</span>
      <span style="background-color: #5865F2; color: #fff; font-size: 15px; font-weight: 500; padding: 2px 6px; border-radius: 4px;  display: inline-flex; align-items: center; justify-content: center; margin-right: 6px; vertical-align: middle; line-height: 1; margin-top: 1px;">APP</span>
      <span style="color: #949ba4; font-size: 14px; font-weight: 400; margin-left: 4px;">8:21 PM</span>
    </div>
    <div style="display: flex; align-items: center; margin-bottom: 2px; flex-wrap: wrap; font-size: 18px;">
 Hello from Camel
    </div>
  </div>
</div>
...
++++
<pre>
<span style="color:grey">2025-10-20 20:31:33.640</span>   <span style="color:deeppink;">2492</span> --- <span style="color:cyan">kafka://myroom?brokers=my-cluster-kafka-</span> : <span style="color:limegreen;">Sent (success) (4ms)</span>
</pre>
++++
+
{empty} +
...
[subs=attributes]
++++
<div style="font-family: 'Roboto', 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #1A1A1E; color: #dbdee1; padding: 16px; display: flex; align-items: flex-start; gap: 16px; width: 35%; max-width: 600px; box-sizing: border-box;">
  <div style="flex-shrink: 0; width: 50px; height: 50px; border-radius: 50%; background-color: #DA373C; display: flex; align-items: center; justify-content: center; overflow: hidden; margin-top: 2px;">
    {ico-discord}
  </div>
  <div style="display: flex; flex-direction: column; width: 100%;">
    <div style="display: flex; align-items: center; margin-bottom: 2px; flex-wrap: wrap;">
      <span style="color: #f2f3f5; font-weight: 400; font-size: 18px; margin-right: 6px; cursor: pointer;">camelbot</span>
      <span style="background-color: #5865F2; color: #fff; font-size: 15px; font-weight: 500; padding: 2px 6px; border-radius: 4px;  display: inline-flex; align-items: center; justify-content: center; margin-right: 6px; vertical-align: middle; line-height: 1; margin-top: 1px;">APP</span>
      <span style="color: #949ba4; font-size: 14px; font-weight: 400; margin-left: 4px;">8:31 PM</span>
    </div>
    <div style="display: flex; align-items: center; margin-bottom: 2px; flex-wrap: wrap; font-size: 18px;">
 <strong style="font-weight: 700; color: #f2f3f5;">{user-username}@test:</strong>&nbsp;Hello from Camel
    </div>
  </div>
</div>
++++
...
++++
<pre>
<span style="color:grey">2025-10-20 20:36:30.640</span>   <span style="color:deeppink;">7697</span> --- <span style="color:cyan">kafka://myroom?brokers=my-cluster-kafka-</span> : <span style="color:limegreen;">Sent (success) (4ms)</span>
</pre>
++++
+
{empty} +
...
<div style="font-family: 'Roboto', 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #1A1A1E; color: #dbdee1; padding: 16px; display: flex; align-items: flex-start; gap: 16px; width: 35%; max-width: 600px; box-sizing: border-box;">
  ...
  <div style="display: flex; flex-direction: column; width: 100%;">
    <div style="display: flex; align-items: center; margin-bottom: 2px; flex-wrap: wrap;">
      <span style="color: #f2f3f5; font-weight: 400; font-size: 18px; margin-right: 6px; cursor: pointer;">camelbot</span>
      <span style="background-color: #5865F2; color: #fff; font-size: 15px; font-weight: 500; padding: 2px 6px; border-radius: 4px;  display: inline-flex; align-items: center; justify-content: center; margin-right: 6px; vertical-align: middle; line-height: 1; margin-top: 1px;">APP</span>
      <span style="color: #949ba4; font-size: 14px; font-weight: 400; margin-left: 4px;">8:36 PM</span>
    </div>
    <div style="display: flex; align-items: center; margin-bottom: 2px; flex-wrap: wrap; font-size: 18px;">
 <strong style="font-weight: 700; color: #f2f3f5;">{user-username}@test:</strong>&nbsp;Hello from Camel
    </div>
...
[subs=attributes]
++++
<div class="integration-flow-wrapper">
  <style>
    .integration-flow-wrapper {
      font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif;
      background-color: white;
      padding: 20px;
      color: #333;
      max-width: 950px; /* Slight increase to prevent wrapping */
    }
    ...
    .flow-container {
      ...
      gap: 0; /* Remove gap, let padding/margin handle spacing */
    }
    ...
    .left-col {
      ...
      gap: 30px;
      z-index: 2; /* Keep above arrows if overlap */
    }
    ...
    .username.matrix-green { color: #00d781; }
    ...
    .arrow-col {
      /* CRITICAL FIX: explicit width and prevent shrinking */
      width: 140px;
      min-width: 120px;
      flex-shrink: 0;
      height: 200px;
      position: relative;
      margin-left: -20px; /* Slight overlap to make arrows look like they come from under */
      margin-right: -20px;
      z-index: 1; /* Sit behind bubbles */
      display: flex;
      align-items: center;
      justify-content: center;
    }
    ...
    .right-col {
      ...
      gap: 15px;
      margin-left: -40px;
      margin-top: 80px; /* Push down visually to align with arrow head */
      z-index: 2;
    }
        ...
        <div class="icon-container">
          <div class="icon-box matrix-bg" style="margin-top: 5px; transform: scale(1);">
            <svg width="45" height="45" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">
              <!--path d="M7 3v18"/><path d="M17 3v18"/><path d="M2 9h20"/-->
              <g transform="translate(-11 -11) scale(0.09)">
              <path stroke-width="30"
d="m153.25 277.15c.47-46.35 37.79-81.6 81.6-81.6m0-42.3c46.35.47 81.6 37.79 81.6 81.6m42.3 0c-.47 46.35-37.79 81.6-81.6 81.6m0 42.3c-46.35 0-81.6-37.79-81.6-81.6"/></g>
            </svg>
          </div>
      ...
      <div class="platform-row">
        <div class="icon-container">
          <div class="icon-box rocket-bg" style="margin-top: -5px;">
          ...
          <span class="icon-label">rocket.chat</span>
        </div>
        <div style="border: 1px solid #ddd; border-radius: 4px; background: #fff; width: 260px; box-shadow: 0 1px 2px rgba(0,0,0,0.05); position: relative; display: flex; flex-direction: row; align-items: flex-start; padding: 8px 10px; gap: 10px; box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;background-color: #F2F3F5">    
          ...
          <div style="display: flex; flex-direction: column; justify-content: center; ">
            <div style="display: flex; align-items: baseline; gap: 8px; margin-bottom: 2px; line-height: 1.2;">
              ...
              <span style="font-size: 11px; color: #aaa;">8:39 PM</span>
            </div>
    ...
    <div class="arrow-col">
      <svg class="arrow-svg" viewBox="0 0 120 220">
        <defs>
            <style>
                .arrow-path-bg { fill: none; stroke: #e0e0e0; stroke-width: 14; }
                .arrow-path-border { fill: none; stroke: #999; stroke-width: 1; }
            </style>
        </defs>
        <path d="M0,40 C65,40 65,160 115,160" class="arrow-path-bg" />
        <path d="M0,33 C73,33 68,153 115,153" class="arrow-path-border" />
        <path d="M0,47 C59,47 59,167 115,167" class="arrow-path-border" />
        <path d="M0,145 C45,145 45,160 115,160" class="arrow-path-bg" />
        <path d="M0,138 C50,138 50,153 115,153" class="arrow-path-border" />
        <path d="M0,152 C50,152 50,167 115,167" class="arrow-path-border" />
        <polygon points="112,146 135,160 112,174" fill="#e0e0e0" stroke="#999" stroke-width="1"/>
      </svg>
    </div>
    <div class="right-col">
      <div style="font-family: 'Roboto', 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #1A1A1E; color: #dbdee1; padding: 16px; display: flex; align-items: flex-start; gap: 16px; width: 500px; max-width: 600px; box-sizing: border-box;transform: scale(.75)">
        <div style="flex-shrink: 0; width: 50px; height: 50px; border-radius: 50%; background-color: #DA373C; display: flex; align-items: center; justify-content: center; overflow: hidden; margin-top: 2px;">
          {ico-discord}
        </div>
        <div style="display: flex; flex-direction: column; width: 100%;">
          <div style="display: flex; align-items: center; margin-bottom: 2px; flex-wrap: wrap;">
            <span style="color: #f2f3f5; font-weight: 400; font-size: 18px; margin-right: 6px; cursor: pointer;">camelbot</span>
            <span style="background-color: #5865F2; color: #fff; font-size: 15px; font-weight: 500; padding: 2px 6px; border-radius: 4px;  display: inline-flex; align-items: center; justify-content: center; margin-right: 6px; vertical-align: middle; line-height: 1; margin-top: 1px;">APP</span>
            <span style="color: #949ba4; font-size: 14px; font-weight: 400; margin-left: 4px;">8:39 PM</span>
          </div>
          <div style="display: flex; align-items: center; margin-bottom: 2px; flex-wrap: wrap; font-size: 18px; gap: 5px">
       <strong style="font-weight: 700; color: #f2f3f5;">{user-username}@matrix:</strong>&nbsp;Hello from Matrix
        <strong style="font-weight: 700; color: #f2f3f5;">{user-username}@rocketchat:</strong>&nbsp;Hello from Rocket.Chat
          </div>
        </div>
      </div>      
      <div style="display:flex; flex-direction:column; align-items:center;">
          <div class="discord-logo-large" style="margin-top: 25px;">             
            <svg width="1024px" height="1024px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
              <circle cx="512" cy="512" r="512" style="fill:#5964F1"/>
              <g transform="scale(1.2, 1.2) translate(-90,-90)">
                 {ico-d-path}
              </g>
            </svg>
          </div>
          <span class="icon-label" style="margin-top:5px; margin-left: -80px;">Discord</span>
      </div>
    </div>
  </div>
</div>
...
[subs=attributes]
++++
      <div style="font-family: 'Roboto', 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #1A1A1E; color: #dbdee1; padding: 16px; display: flex; align-items: flex-start; gap: 16px; width: 300px; box-sizing: border-box;transform: scale(.9);">
        <div style="flex-shrink: 0; width: 50px; height: 50px; border-radius: 50%; background-color: #DA373C; display: flex; align-items: center; justify-content: center; overflow: hidden; margin-top: 2px;">
                      <svg width="1024px" height="1024px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
              <circle cx="512" cy="512" r="512" style="fill:#FAA61C"/>
              <g transform="scale(1.2, 1.2) translate(-90,-90)">
                 {ico-d-path}
              </g>
            </svg>
        ...
        <div style="display: flex; flex-direction: column; width: auto;">
          <div style="display: flex; align-items: center; margin-bottom: 2px; flex-wrap: wrap;">
            <span style="color: #f2f3f5; font-weight: 400; font-size: 18px; margin-right: 6px; cursor: pointer;">{user-username}</span>
<svg xmlns="http://www.w3.org/2000/svg" version="1.0" height="22pt" viewBox="0 0 256 256" style="margin-left: -5px;"><g fill="#53ac66"><path d="M110.9 52.5c5.1 1.3 15.1 7.1 15.1 8.7 0 .5.9.8 2 .8s2-.3 2-.8c0-1.6 10.1-7.4 15.6-8.9 24.3-6.4 45.2 15.1 37.9 39-5.3 17.6-19.2 33.7-44.1 51-10.6 7.4-12.2 7.4-22.8.1-39.7-27.6-54.7-57.2-39.9-78.6 7.3-10.6 20.6-15 34.2-11.3m89.1 57.7c.6.7 2 2.9 3.3 4.8 1.2 1.9 3.8 4.3 5.6 5.2 1.9.9 3.8 2.3 4.2 2.9 1.1 1.9-.7 4.6-4.2 6.4-1.6.9-4.6 3.8-6.6 6.6-2.1 3-4.2 4.9-5.1 4.7s-2.7-2.3-4.2-4.8c-1.5-2.6-4.1-5.3-6.3-6.5-2-1.1-4-2.8-4.3-3.8-.6-2 1.1-4.7 3.1-4.7 1.6 0 8.5-6.8 8.5-8.3 0-3.1 4-4.7 6-2.5m-134.9-3.5c.8 1 2.3 3.5 3.4 5.7 1.3 2.6 3.6 4.8 7.1 6.8 2.9 1.6 5.5 3.6 5.8 4.4.8 2.2-1 5.1-3.6 6-4.3 1.3-8.1 4.7-10 9.1-1.1 2.4-2.6 4.7-3.4 5-2.5.9-6.2-.6-6.9-3-1.3-4.1-5.7-8.9-10-10.7-7-3-6.8-6.8.5-10.5 4.5-2.3 9-7 9-9.4 0-1.5 3.7-5.1 5.3-5.1.8 0 2 .8 2.8 1.7"/><path d="M90.4 149c13.9 2.6 25.9 11.9 33.6 26 2.1 3.9 4.1 7 4.4 7 .4 0 2.2-3 4-6.7 7-13.7 20.2-23.7 34.9-26.4 6.1-1.1 8.8-1 19.3.5 13.4 2 16.2 3.2 17.1 7.4.8 3.2-2.4 14.2-6 21.4-5.1 10.2-18.3 20-30.3 22.8-5.2 1.2-25.8.8-29.4-.6-1.1-.4-1.5.7-1.9 4.7-.6 6-3.2 8.9-7.8 8.9s-7.2-2.9-7.8-8.9c-.4-4-.8-5.1-1.9-4.7-3.6 1.4-24.2 1.8-29.4.6-12-2.8-24.3-12.1-30.1-22.7-4-7.2-7.1-19.4-5.8-22.7 1.3-3.4 3.5-4.3 14.5-6 11.2-1.8 15.8-1.9 22.6-.6"/></g></svg>
            <span style="color: #949ba4; font-size: 14px; font-weight: 400; margin-left: 4px;">1:26 PM</span>
          </div>
          <div style="display: flex; align-items: center; margin-bottom: 2px; flex-wrap: wrap; font-size: 18px; gap: 5px">test Camel listener
          </div>
        </div>
      </div> 
++++
...
NOTE: Stop _Camel JBang_ when done +
...
image::images/new/mapping-discord-kafka.png[align="left", width=70%]
  ...
  <div style="display: flex; align-items: flex-end; margin-top: -50px;">
    ...
    <div style="margin-right: -200px; margin-bottom: 35px;">
      ...
      <div style="display: flex; flex-direction: column; align-items: flex-start;">
        <div class="platform-row">
          <div style="display:flex; flex-direction:column; align-items:center; margin-left: -5px; z-index: 3; ">
            <div class="discord-logo-large" style="margin-top: 50px; margin-left: -5px">             
              <svg width="74px" height="74px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
                <circle cx="512" cy="512" r="512" style="fill:#5964F1"/>
                <g transform="scale(1.2, 1.2) translate(-90,-90)">
                 {ico-d-path}
                </g>
            ...
            <span class="icon-label" style="margin-top:0px; margin-left: -5px">Discord</span>
          </div>
          <div style="font-family: 'Roboto', 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #1A1A1E; color: #dbdee1; padding: 16px; display: flex; align-items: flex-start; gap: 16px; width: 300px; box-sizing: border-box; transform: scale(.8);z-index:2;margin-left:-40px;margin-top:40px">
            <div style="flex-shrink: 0; width: 50px; height: 50px; border-radius: 50%; background-color: #DA373C; display: flex; align-items: center; justify-content: center; overflow: hidden; margin-top: 2px;">
              <svg width="1024px" height="1024px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
                <circle cx="512" cy="512" r="512" style="fill:#FAA61C"/>
                <g transform="scale(1.2, 1.2) translate(-90,-90)">
            ...
            <div style="display: flex; flex-direction: column; width: auto;">
              <div style="display: flex; align-items: center; margin-bottom: 2px; flex-wrap: wrap;">
                <span style="color: #f2f3f5; font-weight: 400; font-size: 18px; margin-right: 6px; cursor: pointer;">{user-username}</span>
                <svg xmlns="http://www.w3.org/2000/svg" version="1.0" height="22pt" viewBox="0 0 256 256" style="margin-left: -5px;"><g fill="#53ac66"><path d="M110.9 52.5c5.1 1.3 15.1 7.1 15.1 8.7 0 .5.9.8 2 .8s2-.3 2-.8c0-1.6 10.1-7.4 15.6-8.9 24.3-6.4 45.2 15.1 37.9 39-5.3 17.6-19.2 33.7-44.1 51-10.6 7.4-12.2 7.4-22.8.1-39.7-27.6-54.7-57.2-39.9-78.6 7.3-10.6 20.6-15 34.2-11.3m89.1 57.7c.6.7 2 2.9 3.3 4.8 1.2 1.9 3.8 4.3 5.6 5.2 1.9.9 3.8 2.3 4.2 2.9 1.1 1.9-.7 4.6-4.2 6.4-1.6.9-4.6 3.8-6.6 6.6-2.1 3-4.2 4.9-5.1 4.7s-2.7-2.3-4.2-4.8c-1.5-2.6-4.1-5.3-6.3-6.5-2-1.1-4-2.8-4.3-3.8-.6-2 1.1-4.7 3.1-4.7 1.6 0 8.5-6.8 8.5-8.3 0-3.1 4-4.7 6-2.5m-134.9-3.5c.8 1 2.3 3.5 3.4 5.7 1.3 2.6 3.6 4.8 7.1 6.8 2.9 1.6 5.5 3.6 5.8 4.4.8 2.2-1 5.1-3.6 6-4.3 1.3-8.1 4.7-10 9.1-1.1 2.4-2.6 4.7-3.4 5-2.5.9-6.2-.6-6.9-3-1.3-4.1-5.7-8.9-10-10.7-7-3-6.8-6.8.5-10.5 4.5-2.3 9-7 9-9.4 0-1.5 3.7-5.1 5.3-5.1.8 0 2 .8 2.8 1.7"/><path d="M90.4 149c13.9 2.6 25.9 11.9 33.6 26 2.1 3.9 4.1 7 4.4 7 .4 0 2.2-3 4-6.7 7-13.7 20.2-23.7 34.9-26.4 6.1-1.1 8.8-1 19.3.5 13.4 2 16.2 3.2 17.1 7.4.8 3.2-2.4 14.2-6 21.4-5.1 10.2-18.3 20-30.3 22.8-5.2 1.2-25.8.8-29.4-.6-1.1-.4-1.5.7-1.9 4.7-.6 6-3.2 8.9-7.8 8.9s-7.2-2.9-7.8-8.9c-.4-4-.8-5.1-1.9-4.7-3.6 1.4-24.2 1.8-29.4.6-12-2.8-24.3-12.1-30.1-22.7-4-7.2-7.1-19.4-5.8-22.7 1.3-3.4 3.5-4.3 14.5-6 11.2-1.8 15.8-1.9 22.6-.6"/></g></svg>
                <span style="color: #949ba4; font-size: 14px; font-weight: 400; margin-left: 4px;">1:37 PM</span>
              </div>
              <div style="display: flex; align-items: center; margin-bottom: 2px; flex-wrap: wrap; font-size: 18px; gap: 5px">Hello from Discord
              </div>
            </div>
          </div> 
        </div>
      </div>
      <div style="margin-left: 150px; margin-top: -60px" class="platform-row">
        <svg width="120" height="120" viewBox="0 0 130 180" fill="none" xmlns="http://www.w3.org/2000/svg" style="display: block;z-index:1">
          <path d="M20 10H45V80C45 113.137 71.8629 140 105 140H120V120L150 150L120 180V160H105C58.0558 160 20 121.944 20 75V10Z" fill="#E0E0E0" stroke="#A0A0A0" stroke-width="2"/>
        </svg>
        <!-- Content Column -->
        <div style="display: flex; flex-direction: column; align-items: flex-start;">
          <div style="display: flex; flex-direction: column; align-items: flex-start;">
            <div class="platform-row" style="margin-top: 75px; margin-left: -60px">
              <div class="icon-container" >
                <div class="icon-box rocket-bg" style="margin-top: -5px; margin-left: 850px;transform: scale(1.2)" >
                  <svg width="45" height="45" viewBox="0 0 24 24" fill="white">
                    <g transform="translate(-2 -2) scale(.9)">
                      <path d="M 7.5488281 5 C 6.2638281 5 5.055 5.3086094 4 5.8496094 C 5.422467 6.9694938 6.4322525 8.5274703 6.8359375 10.300781 C 5.0652471 11.854193 4 13.838545 4 16 C 4 18.1 5.0028438 20.110797 6.8398438 21.716797 C 6.5498438 22.966797 5.9480312 24.134047 5.0820312 25.123047 L 4.0136719 26.345703 L 5.5859375 26.751953 C 6.2259375 26.917953 6.8868281 27 7.5488281 27 C 9.7768281 27 11.841828 26.197516 13.423828 24.728516 C 14.425828 24.908516 15.458 25 16.5 25 C 23.393 25 29 20.962 29 16 C 29 11.038 23.393 7 16.5 7 C 15.440923 7 14.418235 7.1058017 13.435547 7.2851562 C 11.913547 5.8774278 9.8442485 5 7.5488281 5 z M 16.5 9 C 22.29 9 27 12.14 27 16 C 27 19.86 22.29 23 16.5 23 C 15.412 23 14.338594 22.888969 13.308594 22.667969 L 12.757812 22.548828 L 12.371094 22.957031 C 11.147094 24.252031 9.469625 24.976 7.640625 25 C 8.290625 23.917 8.727875 22.724516 8.921875 21.478516 L 9.0136719 20.896484 L 8.5488281 20.535156 C 6.9058281 19.256156 6 17.646 6 16 C 6 12.14 10.71 9 16.5 9 z M 11.5 15 A 1.5 1.5 0 0 0 11.5 18 A 1.5 1.5 0 0 0 11.5 15 z M 16.5 15 A 1.5 1.5 0 0 0 16.5 18 A 1.5 1.5 0 0 0 16.5 15 z M 21.5 15 A 1.5 1.5 0 0 0 21.5 18 A 1.5 1.5 0 0 0 21.5 15 z"/>
                    </g>
                ...
                <span class="icon-label" style="margin-left: 850px">rocket.chat</span>
              </div>
              <div style="border: 1px solid #ddd; border-radius: 4px; background: #fff; width: 380px; box-shadow: 0 1px 2px rgba(0,0,0,0.05); position: relative; display: flex; flex-direction: row; align-items: flex-start; padding: 8px 10px; gap: 10px; box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;background-color: #F2F3F5">    
                <div style="width: 32px; height: 32px; background-color: #6c757d; color: white; border-radius: 4px; display: flex; align-items: center; justify-content: center; font-weight: bold; font-size: 16px; flex-shrink: 0;">
                U
                </div>
                <div style="display: flex; flex-direction: column; justify-content: center; ">
                  <div style="display: flex; align-items: baseline; gap: 8px; margin-bottom: 2px; line-height: 1.2;">
                    <span style="font-weight: bold; font-size: 14px; color: #333;">{user-username}</span>
                    <span style="font-size: 11px; color: #aaa;">1:37 PM</span>
                  </div>
                  <div style="font-size: 14px; color: #333; line-height: 1; margin: 0; padding: 0;">
                    <strong>{user-username}@discord: </strong>Hello from Discord
                  </div>
                </div>
              </div>
            </div>
      ...
      <div style="margin-left: 150px; margin-top: -50px" class="platform-row">
        <svg width="120" height="200" viewBox="0 0 160 290" fill="none" xmlns="http://www.w3.org/2000/svg" style="display: block; margin-top: -70; margin-left:9.5;z-index: 0;transform: scale(.95)">
          <path d="M20 10 
             H45
             V180 
             C45 213.137 71.8629 240 105 240 
             H120 
             V220 
             L150 250 
             L120 280 
             V260 
             H105 
             C58.0558 260 20 221.944 20 175 
             V10 
             Z" 
          fill="#E0E0E0" 
          stroke="#A0A0A0" 
        ...
        <div style="display: flex; flex-direction: column; align-items: flex-start;">
          <!-- Content Column -->
          <div style="display: flex; flex-direction: column; align-items: flex-start; margin-left:-70px;margin-top: 70px">
            <div class="platform-row" >
              <!-- Matrix Icon -->
              <div class="icon-container">
                <div class="icon-box matrix-bg" style="margin-left: 850px;margin-top: 5px; transform: scale(1.2);">
                  <svg width="45" height="45" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">
                    <g transform="translate(-11 -11) scale(0.09)">
                ...
                <span class="icon-label" style="margin-left: 850px;">Matrix</span>
              </div>
              <!-- Matrix Message Box -->
              <div style="border: 1px solid #ddd; border-radius: 4px; background: #fff; width: 380px; box-shadow: 0 1px 2px rgba(0,0,0,0.05); display: flex; flex-direction: column; padding: 5px 5px; gap: 2px; box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
                <div style="display: flex; align-items: center;">
                  <div style="width: 30px; height: 30px; background-color: #4a90e2; color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 600; font-size: 16px; flex-shrink: 0;">
                      U
                  </div>
          ...
          <div style="font-family: 'Roboto', 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #1A1A1E; color: #dbdee1; padding: 16px; display: flex; align-items: flex-start; gap: 16px; width: 300px; box-sizing: border-box; transform: scale(.8);z-index:2;margin-left:-40px;margin-top:40px">
            ...
            <div style="display: flex; flex-direction: column; width: auto;">
              <div style="display: flex; align-items: center; margin-bottom: 2px; flex-wrap: wrap;">
                <span style="color: #f2f3f5; font-weight: 400; font-size: 18px; margin-right: 6px; cursor: pointer;">{user-username}</span>
                <svg xmlns="http://www.w3.org/2000/svg" version="1.0" height="22pt" viewBox="0 0 256 256" style="margin-left: -5px;"><g fill="#53ac66"><path d="M110.9 52.5c5.1 1.3 15.1 7.1 15.1 8.7 0 .5.9.8 2 .8s2-.3 2-.8c0-1.6 10.1-7.4 15.6-8.9 24.3-6.4 45.2 15.1 37.9 39-5.3 17.6-19.2 33.7-44.1 51-10.6 7.4-12.2 7.4-22.8.1-39.7-27.6-54.7-57.2-39.9-78.6 7.3-10.6 20.6-15 34.2-11.3m89.1 57.7c.6.7 2 2.9 3.3 4.8 1.2 1.9 3.8 4.3 5.6 5.2 1.9.9 3.8 2.3 4.2 2.9 1.1 1.9-.7 4.6-4.2 6.4-1.6.9-4.6 3.8-6.6 6.6-2.1 3-4.2 4.9-5.1 4.7s-2.7-2.3-4.2-4.8c-1.5-2.6-4.1-5.3-6.3-6.5-2-1.1-4-2.8-4.3-3.8-.6-2 1.1-4.7 3.1-4.7 1.6 0 8.5-6.8 8.5-8.3 0-3.1 4-4.7 6-2.5m-134.9-3.5c.8 1 2.3 3.5 3.4 5.7 1.3 2.6 3.6 4.8 7.1 6.8 2.9 1.6 5.5 3.6 5.8 4.4.8 2.2-1 5.1-3.6 6-4.3 1.3-8.1 4.7-10 9.1-1.1 2.4-2.6 4.7-3.4 5-2.5.9-6.2-.6-6.9-3-1.3-4.1-5.7-8.9-10-10.7-7-3-6.8-6.8.5-10.5 4.5-2.3 9-7 9-9.4 0-1.5 3.7-5.1 5.3-5.1.8 0 2 .8 2.8 1.7"/><path d="M90.4 149c13.9 2.6 25.9 11.9 33.6 26 2.1 3.9 4.1 7 4.4 7 .4 0 2.2-3 4-6.7 7-13.7 20.2-23.7 34.9-26.4 6.1-1.1 8.8-1 19.3.5 13.4 2 16.2 3.2 17.1 7.4.8 3.2-2.4 14.2-6 21.4-5.1 10.2-18.3 20-30.3 22.8-5.2 1.2-25.8.8-29.4-.6-1.1-.4-1.5.7-1.9 4.7-.6 6-3.2 8.9-7.8 8.9s-7.2-2.9-7.8-8.9c-.4-4-.8-5.1-1.9-4.7-3.6 1.4-24.2 1.8-29.4.6-12-2.8-24.3-12.1-30.1-22.7-4-7.2-7.1-19.4-5.8-22.7 1.3-3.4 3.5-4.3 14.5-6 11.2-1.8 15.8-1.9 22.6-.6"/></g></svg>
                <span style="color: #949ba4; font-size: 14px; font-weight: 400; margin-left: 4px;">1:43 PM</span>
              </div>
              <div style="display: flex; align-items: center; margin-bottom: 2px; flex-wrap: wrap; font-size: 18px; gap: 5px">Hello from Discord
              </div>
            </div>
            ...
            <div class="platform-row" style="margin-top: 75px; margin-left: -60px">
              ...
              <div style="border: 1px solid #ddd; border-radius: 4px; background: #fff; width: 380px; box-shadow: 0 1px 2px rgba(0,0,0,0.05); position: relative; display: flex; flex-direction: row; align-items: flex-start; padding: 8px 10px; gap: 10px; box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;background-color: #F2F3F5">    
                ...
                <div style="display: flex; flex-direction: column; justify-content: center; ">
                  <div style="display: flex; align-items: baseline; gap: 8px; margin-bottom: 2px; line-height: 1.2;">
                    <span style="font-weight: bold; font-size: 14px; color: #333;">{user-username}</span>
                    <span style="font-size: 11px; color: #aaa;">1:43 PM</span>
                  </div>
                  <div style="font-size: 14px; color: #333; line-height: 1; margin: 0; padding: 0;">
                    <strong>{user-username}@discord: </strong>Hello from Discord
                  </div>
