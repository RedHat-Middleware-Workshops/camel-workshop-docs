...
:ico-discord: pass:[<svg width="1024px" height="1024px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"> \
...
<div style="font-family: 'Roboto', 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #1A1A1E; color: #dbdee1; padding: 16px; display: flex; align-items: flex-start; gap: 16px; width: 35%; max-width: 600px; box-sizing: border-box;">
  ...
  <div style="display: flex; flex-direction: column; width: 100%;">
    <div style="display: flex; align-items: center; margin-bottom: 2px; flex-wrap: wrap;">
      ...
      <span style="background-color: #5865F2; color: #fff; font-size: 14px; font-weight: 700; padding: 0 4px; border-radius: 4px; height: 18px; display: inline-flex; align-items: center; justify-content: center; margin-right: 6px; vertical-align: middle; line-height: 1; margin-top: 1px;">APP</span>
      <span style="color: #949ba4; font-size: 14px; font-weight: 400; margin-left: 4px;">10:35 PM</span>
    </div>
