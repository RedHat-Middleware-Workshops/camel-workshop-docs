...
:images: /walkthroughs/camel-workshop-docs-labs-stage1-lab/files/images
...
However, this flow only moves messages in one direction. In the next chapter you will enable a bi-directional data flow between the two systems, but it won’t be as straightforward as you might think.

Jump to the next chapter to find out !
