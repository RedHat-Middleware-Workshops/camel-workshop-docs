...
Start here and complete the chapters below to familiarise yourself with the workshop goals, the scenario it’s based on, and get an introduction covering the content, key technologies, and what to expect from the lab exercises.
