...
image:images/new/devspaces-login.jpg[align="left", width=60%]
+
{empty} +
+
...
If you have a wide or multi-monitor setup, it is mostly recommended to organise your browser tabs with the _DevSpaces_ view next to your lab instructions side by side, as per the image below:
