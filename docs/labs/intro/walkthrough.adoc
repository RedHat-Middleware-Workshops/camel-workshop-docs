...
image::images/new/workshop-progress-value.png[align="center", width=60%]
...
image::images/new/scenario-problem.png[align="center", width=40%]
...
image::images/new/scenario-message-hub.png[align="center", width=40%]
...
+
image:images/new/devspaces-login-with-ocp.png[align="left", width=30%]
+
{empty} +
...
+
image::images/new/devspaces-dashboard-auth.png[align="left", width=40%]
+
{empty} +
+
