...
This is a quick overview of the workshop goals and what to expect from the lab exercices as you make progress by completing the tasks.
...
If you're unfamilar with Apache Camel, in a nutshell, it is an integration framework to define data flows connecting sources to destinations, applying _EIPs_ (enterprise integration patterns) as mediation processes between the two ends.
