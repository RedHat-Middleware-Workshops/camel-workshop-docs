...
+
image::images/new/mapping-matrix-kafka.png[align="left", width=80%]
+
{empty} +
...
The mapping rendering should be similar to:
+
image::images/new/mapping-rocketchat-kafka.png[align="left", width=90%]
+
{empty} +
...
The mapping rendering should be similar to:
+
image::images/new/mapping-kafka-rocketchat.png[align="left", width=70%]
+
{empty} +
...
The mapping rendering should be similar to:
+
image::images/new/mapping-kafka-matrix.png[align="left", width=70%]
+
{empty} +
